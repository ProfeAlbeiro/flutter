    ...
    window.onload = function() {
        const ui = SwaggerUIBundle({
            ...
            persistAuthorization: {
                !!config('l5-swagger.ui.authorization.persist_authorization') ? 'true' : 'false'!!
            },
            docExpansion: "{!! config('l5-swagger.ui.display.doc_expansion', 'none') !!}",
            deepLinking: true,
            filter: {
                !!config('l5-swagger.ui.display.filter') ? 'true' : 'false'!!
            },
            defaultModelsExpandDepth: {
                !!config('l5-swagger.ui.display.default_models_expand_depth', 1) !!
            },
            defaultModelExpandDepth: {
                !!config('l5-swagger.ui.display.default_model_expand_depth', 1) !!
            },
            displayOperationId: {
                !!config('l5-swagger.ui.display.display_operation_id') ? 'true' : 'false'!!
            },
            displayRequestDuration: {
                !!config('l5-swagger.ui.display.display_request_duration') ? 'true' : 'false'!!
            },
            syntaxHighlightTheme: "{!! config('l5-swagger.ui.display.syntax_highlight_theme', 'agate') !!}",
            schemes: ['https'],
        })
        @endif
    }
